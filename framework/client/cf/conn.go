...
import (
	...
	"github.com/nexusnet/sds/framework/core"
	"github.com/nexusnet/sds/msg"
	"github.com/nexusnet/sds/msg/header"
	"github.com/nexusnet/sds/utils/cmem"

	"github.com/nexusnet/sds/utils"
...
type (
	onConnectFunc func(core.WriteCloser) bool
	onMessageFunc func(msg.RelayMsgBuf, core.WriteCloser)
	onCloseFunc   func(core.WriteCloser)
	onErrorFunc   func(core.WriteCloser)
)
...
func asyncWrite(c *ClientConn, m *msg.RelayMsgBuf) (err error) {
	...
	var sendCh chan *msg.RelayMsgBuf
	sendCh = c.sendCh
